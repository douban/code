...
/* autogeneration */
define("lib/codemirror.js", [], function(){});

/* @source mod/overlay.js */;
...
/* @source mod/loadmode.js */;

define('mod/loadmode', [
  "codemirror"
], function(CodeMirror){
(function() {
  if (!CodeMirror.modeURL) CodeMirror.modeURL = "/static/js/lib/mode/%N.js";
...
require(['codemirror', 'mod/editor', 'mod/zclip'], function(){
    //do any thing?
});
