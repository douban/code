...
/***/ function(module, exports, __webpack_require__) {
	...
	var _signin = __webpack_require__(159);
	
	var _signin2 = _interopRequireDefault(_signin);
	
	_reactDom2['default'].render(_react2['default'].createElement(_signin2['default'], null), document.getElementById('main'));
	    ...
	    function LoginComponent(props) {
	        ...
	        this.saveAndContinue = function (event) {
	            ...
	            var data = {
	                ...
	                'continue': decodeURIComponent((0, _componentsUtils.getQueryVariable)('continue'))
	            },
	                self = _this;
	
	            _jquery2['default'].post('/login/', data).done(function (result) {
	        ...
	        this.handleUsernameInput = function (event) {
	            _this.setState({
