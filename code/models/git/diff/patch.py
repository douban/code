...
from code.libs.text import is_image
from code.libs.generated import Generated
from code.models.consts import LINECOMMENT_INDEX_EMPTY
from code.models.git.diff.hunk import Hunk
    ...
    def init_comment_groups(self):
        ...
        if self.linecomments_has_linenum:
            ...
            self.comments_by_line = dict((k, list(v))
                    for k, v in groupby(self.linecomments_has_linenum, key=keyfunc_line))
